...
__webpack_require__.d(__webpack_exports__, "MapInteraction", function() { return /* reexport */ src_MapInteraction; });
...
function MapInteraction_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var MapInteraction_MapInteraction = /*#__PURE__*/function (_Component) {
  MapInteraction_inherits(MapInteraction, _Component);

  var _super = MapInteraction_createSuper(MapInteraction);
  ...
  MapInteraction_createClass(MapInteraction, [{
    ...
    */
    ...
    value: function scaleFromMultiTouch(e) {
      ...
      var focalPt = this.clientPosToTranslatedPos(startMidpoint, this.startPointerInfo.translation); // The amount that middle point has changed from this scaling
...
var MapInteractionCSS_MapInteractionCSS = function MapInteractionCSS(props) {
  return /*#__PURE__*/external_commonjs_react_commonjs2_react_amd_React_root_React_default.a.createElement(src_MapInteraction, props, function (_ref) {
